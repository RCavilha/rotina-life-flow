    ...
    <Layout>
      ...
      <div className="max-w-md mx-auto px-6 mt-6">
        ...
        <div className="flex gap-3 mb-6">
          <Button className="flex-1 h-auto py-4 flex-col gap-2 bg-gradient-primary hover:opacity-90 transition-opacity">
            <Plus size={22} />
        ...
        <Card className="p-5 shadow-soft">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-lg">Tarefas Compartilhadas</h3>
            </div>
          </div>
